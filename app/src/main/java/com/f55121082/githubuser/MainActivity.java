package com.f55121082.githubuser;
...
public class MainActivity<listUser> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of Qoutes / F55121082");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
